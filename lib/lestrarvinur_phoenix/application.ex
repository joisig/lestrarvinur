defmodule LestrarvinurPhoenix.Application do
  ...
  def start(_type, _args) do
    children = [
      LestrarvinurPhoenixWeb.Telemetry,
      ...
      LestrarvinurPhoenixWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: LestrarvinurPhoenix.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    LestrarvinurPhoenixWeb.Endpoint.config_change(changed, removed)
    :ok
  end
